...
class GithubSearchInput(BaseModel):
    ...
    max_repos: str = Field(default="3", description="Maximum number of repositories to return. Must be an integer between 1 and 10.")
...
def githubSearchTool(query: str, max_repos = "3", sort: str = "stars", language: str = "") -> list:
    """
