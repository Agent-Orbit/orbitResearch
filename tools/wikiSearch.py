...
class WikipediaSearchInput(BaseModel):
    ...
    k_results: int = Field(default=3, description="Number of Wikipedia articles to return. Between 1 and 5.")
    max_content_chars: int = Field(default=4000, description="Maximum characters of content per article. Use higher values for more detail.")


@tool(args_schema=WikipediaSearchInput)
def wikipediaSearch(query: str, k_results: int = 3, max_content_chars: int = 4000) -> str:
    """
